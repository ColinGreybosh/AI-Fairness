...
class TestAlgorithms:
    ...
    def run_dir(self, dataset_orig_train, dataset_orig_val, dataset_orig_test,  sens_attr, model_type, dir_metrics, f_label, uf_label, unprivileged_groups, privileged_groups, THRESH_ARR, DISPLAY, SCALER):
        print('\n------------------------------\n')
        print('[INFO] preprocessing--disparat impact remover ......')
        print('\n------------------------------\n')
        dir_mitigator = DIRMitigator()
        dir_metrics = dir_mitigator.run_mitigator(dataset_orig_train, dataset_orig_val, dataset_orig_test,  sens_attr, model_type, dir_metrics, f_label, uf_label, unprivileged_groups, privileged_groups, THRESH_ARR, DISPLAY, SCALER)

        return dir_metrics

    def run_rew(self, dataset_orig_train, dataset_orig_val, dataset_orig_test, f_label, uf_label,  unprivileged_groups, privileged_groups, model_type, reweigh_metrics, THRESH_ARR, DISPLAY, SCALER):
        print('\n------------------------------\n')
        print('[INFO] preprocessing--reweighting ......')
        print('\n------------------------------\n')
        rew_mitigator = ReweighMitigator()
        reweigh_metrics = rew_mitigator.run_mitigator(dataset_orig_train, dataset_orig_val, dataset_orig_test, f_label, uf_label,  unprivileged_groups, privileged_groups, model_type, reweigh_metrics, THRESH_ARR, DISPLAY, SCALER)
