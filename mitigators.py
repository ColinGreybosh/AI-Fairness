...
class DIRMitigator(BaseMitigator):
    ...
    def run_mitigator(self, dataset_orig_train, dataset_orig_val, dataset_orig_test,  
                      sensitive_attribute, model_type, dir_metrics, 
        ...
        dir_metrics = get_test_metrics(dataset, dataset_dir_val, dataset_dir_test, model_type, dir_metrics, f_label, uf_label, unprivileged_groups, privileged_groups, THRESH_ARR, DISPLAY, SCALER)
...
class ReweighMitigator(BaseMitigator):
    ...
    def run_mitigator(self, dataset_orig_train, dataset_orig_val, dataset_orig_test,
                      f_label, uf_label, unprivileged_groups, privileged_groups, model_type, reweigh_metrics, 
                      THRESH_ARR, DISPLAY, SCALER):
